...
impl<const OPEN_DRAIN: bool, const FULL_DRIVE: bool, const SLOW_SLEW: bool> PinMode
    for Output<OPEN_DRAIN, FULL_DRIVE, SLOW_SLEW>
{
...
impl<const OPEN_DRAIN: bool, const FULL_DRIVE: bool, const SLOW_SLEW: bool> private::Sealed
    for Output<OPEN_DRAIN, FULL_DRIVE, SLOW_SLEW>
{
}

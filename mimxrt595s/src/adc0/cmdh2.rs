...
pub enum CMPEN_A {
    ...
    #[doc = "2: Enabled. Store on true."]
    COMPARE_RESULT_STORE_IF_TRUE = 2,
    #[doc = "3: Enabled. Repeat channel acquisition (sample, convert, and compare) until true."]
...
impl CMPEN_R {
    ...
    pub fn variant(&self) -> Option<CMPEN_A> {
        match self.bits {
            0 => Some(CMPEN_A::DISABLED_ALWAYS_STORE_RESULT),
            2 => Some(CMPEN_A::COMPARE_RESULT_STORE_IF_TRUE),
            3 => Some(CMPEN_A::COMPARE_RESULT_KEEP_CONVERTING_UNTIL_TRUE_STORE_IF_TRUE),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED_ALWAYS_STORE_RESULT`"]
    #[inline(always)]
    pub fn is_disabled_always_store_result(&self) -> bool {
        *self == CMPEN_A::DISABLED_ALWAYS_STORE_RESULT
    }
    #[doc = "Checks if the value of the field is `COMPARE_RESULT_STORE_IF_TRUE`"]
    #[inline(always)]
    pub fn is_compare_result_store_if_true(&self) -> bool {
        *self == CMPEN_A::COMPARE_RESULT_STORE_IF_TRUE
    }
    #[doc = "Checks if the value of the field is `COMPARE_RESULT_KEEP_CONVERTING_UNTIL_TRUE_STORE_IF_TRUE`"]
    #[inline(always)]
    pub fn is_compare_result_keep_converting_until_true_store_if_true(&self) -> bool {
        *self == CMPEN_A::COMPARE_RESULT_KEEP_CONVERTING_UNTIL_TRUE_STORE_IF_TRUE
    }
}
...
impl<'a, const O: u8> CMPEN_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled_always_store_result(self) -> &'a mut W {
        self.variant(CMPEN_A::DISABLED_ALWAYS_STORE_RESULT)
    }
    #[doc = "Enabled. Store on true."]
    #[inline(always)]
    pub fn compare_result_store_if_true(self) -> &'a mut W {
        self.variant(CMPEN_A::COMPARE_RESULT_STORE_IF_TRUE)
    }
    #[doc = "Enabled. Repeat channel acquisition (sample, convert, and compare) until true."]
    #[inline(always)]
    pub fn compare_result_keep_converting_until_true_store_if_true(self) -> &'a mut W {
        self.variant(CMPEN_A::COMPARE_RESULT_KEEP_CONVERTING_UNTIL_TRUE_STORE_IF_TRUE)
    }
}

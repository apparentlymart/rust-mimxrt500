...
impl PAUSEEN_R {
    ...
    pub fn variant(&self) -> PAUSEEN_A {
        match self.bits {
            false => PAUSEEN_A::DISABLED,
            true => PAUSEEN_A::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == PAUSEEN_A::DISABLED
    }
    #[doc = "Checks if the value of the field is `ENABLED`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == PAUSEEN_A::ENABLED
    }
}
...
impl<'a, const O: u8> PAUSEEN_W<'a, O> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(PAUSEEN_A::DISABLED)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(PAUSEEN_A::ENABLED)
    }
}
impl R {

...
pub struct R(crate::R<RAM16_RULE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAM16_RULE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAM16_RULE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAM16_RULE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RAM16_RULE[%s]` writer"]
pub struct W(crate::W<RAM16_RULE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAM16_RULE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAM16_RULE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAM16_RULE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RULE0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE0_A, 2, O>;
...
pub type RULE1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE1_A, 2, O>;
...
pub type RULE2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE2_A, 2, O>;
...
pub type RULE3_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE3_A, 2, O>;
...
pub type RULE4_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE4_A, 2, O>;
...
pub type RULE5_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE5_A, 2, O>;
...
pub type RULE6_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE6_A, 2, O>;
...
pub type RULE7_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RAM16_RULE_SPEC, u8, RULE7_A, 2, O>;
...
#[doc = "SRAM Partition 16 Rule(n) Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ram16_rule](index.html) module"]
pub struct RAM16_RULE_SPEC;
impl crate::RegisterSpec for RAM16_RULE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ram16_rule::R](R) reader structure"]
impl crate::Readable for RAM16_RULE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ram16_rule::W](W) writer structure"]
impl crate::Writable for RAM16_RULE_SPEC {
    type Writer = W;
...
to value 0"]
impl crate::Resettable for RAM16_RULE_SPEC {

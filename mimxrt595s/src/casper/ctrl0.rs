...
#[doc = "Field `ABBPAIR` reader - ABOFF Bank Pair"]
...
#[doc = "Field `ABBPAIR` writer - ABOFF Bank Pair"]
...
#[doc = "Field `CDBPAIR` writer - CDOFF Bank Pair"]

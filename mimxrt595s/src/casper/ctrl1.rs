...
#[doc = "Field `ITER` reader - Interation Counter"]
pub type ITER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ITER` writer - Interation Counter"]
...
#[doc = "Field `RESBPAIR` reader - RESOFF Bank Pair"]
pub type RESBPAIR_R = crate::BitReader<RESBPAIR_A>;
#[doc = "RESOFF Bank Pair\n\nValue on reset: 0"]
...
#[doc = "Field `RESBPAIR` writer - RESOFF Bank Pair"]
...
#[doc = "Field `CSKIP` writer - Skip Rules on Carry"]
...
impl R {
    #[doc = "Bits 0:7 - Interation Counter"]
    #[inline(always)]

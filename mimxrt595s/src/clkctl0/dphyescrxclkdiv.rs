#[doc = "Register `DPHYESCRXCLKDIV` reader"]
pub struct R(crate::R<DPHYESCRXCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DPHYESCRXCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DPHYESCRXCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DPHYESCRXCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DPHYESCRXCLKDIV` writer"]
pub struct W(crate::W<DPHYESCRXCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DPHYESCRXCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DPHYESCRXCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DPHYESCRXCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DPHYESCRXCLKDIV_SPEC, u8, u8, 8, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, DPHYESCRXCLKDIV_SPEC, RESET_A, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DPHYESCRXCLKDIV_SPEC, HALT_A, O>;
...
pub type REQFLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, DPHYESCRXCLKDIV_SPEC, REQFLAG_A, O>;
...
#[doc = "MIPI-DSI DPHY Escape Mode Receive Clock Divider\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dphyescrxclkdiv](index.html) module"]
pub struct DPHYESCRXCLKDIV_SPEC;
impl crate::RegisterSpec for DPHYESCRXCLKDIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dphyescrxclkdiv::R](R) reader structure"]
impl crate::Readable for DPHYESCRXCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dphyescrxclkdiv::W](W) writer structure"]
impl crate::Writable for DPHYESCRXCLKDIV_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DPHYESCRXCLKDIV to value 0x4000_0010"]
impl crate::Resettable for DPHYESCRXCLKDIV_SPEC {
    const RESET_VALUE: Self::Ux = 0x4000_0010;
}

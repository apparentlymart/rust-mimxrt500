#[doc = "Register `LOWFREQCLKDIV` reader"]
pub struct R(crate::R<LOWFREQCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LOWFREQCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LOWFREQCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LOWFREQCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LOWFREQCLKDIV` writer"]
pub struct W(crate::W<LOWFREQCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LOWFREQCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LOWFREQCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LOWFREQCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LOWFREQCLKDIV_SPEC, u8, u8, 8, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWFREQCLKDIV_SPEC, RESET_A, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWFREQCLKDIV_SPEC, HALT_A, O>;
...
pub type REQFLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWFREQCLKDIV_SPEC, REQFLAG_A, O>;
...
pub struct LOWFREQCLKDIV_SPEC;
impl crate::RegisterSpec for LOWFREQCLKDIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lowfreqclkdiv::R](R) reader structure"]
impl crate::Readable for LOWFREQCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lowfreqclkdiv::W](W) writer structure"]
impl crate::Writable for LOWFREQCLKDIV_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LOWFREQCLKDIV to value 0"]
impl crate::Resettable for LOWFREQCLKDIV_SPEC {

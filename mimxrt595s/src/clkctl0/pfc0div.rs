#[doc = "Register `PFC0DIV` reader"]
pub struct R(crate::R<PFC0DIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PFC0DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PFC0DIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PFC0DIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PFC0DIV` writer"]
pub struct W(crate::W<PFC0DIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PFC0DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PFC0DIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PFC0DIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PFC0DIV_SPEC, u8, u8, 8, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFC0DIV_SPEC, RESET_A, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFC0DIV_SPEC, HALT_A, O>;
...
pub type REQFLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFC0DIV_SPEC, REQFLAG_A, O>;
...
#[doc = "PFC divider 0 (trace clock)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pfc0div](index.html) module"]
pub struct PFC0DIV_SPEC;
impl crate::RegisterSpec for PFC0DIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pfc0div::R](R) reader structure"]
impl crate::Readable for PFC0DIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pfc0div::W](W) writer structure"]
impl crate::Writable for PFC0DIV_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PFC0DIV to value 0x4000_0000"]
impl crate::Resettable for PFC0DIV_SPEC {

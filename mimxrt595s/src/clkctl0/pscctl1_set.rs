...
pub enum SDIO0_CLK_AW {
    #[doc = "0: No effect"]
    NO_EFFECT = 0,
    #[doc = "1: Sets the corresponding bit in PSCCTL1 register"]
    CLK_ENABLE_SET = 1,
}
...
pub type SDIO0_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL1_SET_SPEC, SDIO0_CLK_AW, O>;
impl<'a, const O: u8> SDIO0_CLK_W<'a, O> {
    ...
    #[doc = "Sets the corresponding bit in PSCCTL1 register"]
    #[inline(always)]
    pub fn clk_enable_set(self) -> &'a mut W {
        self.variant(SDIO0_CLK_AW::CLK_ENABLE_SET)
    }
}
#[doc = "SDIO1 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type SDIO1_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL1_SET_SPEC, SDIO1_CLK_AW, O>;
impl<'a, const O: u8> SDIO1_CLK_W<'a, O> {
    ...
    #[inline(always)]
    pub fn clk_enable_set(self) -> &'a mut W {
        self.variant(SDIO1_CLK_AW::CLK_ENABLE_SET)
    }
}
#[doc = "ACMP0 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `ACMP0_CLK` writer - ACMP0 clock set"]
pub type ACMP0_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL1_SET_SPEC, ACMP0_CLK_AW, O>;
impl<'a, const O: u8> ACMP0_CLK_W<'a, O> {
    ...
    #[inline(always)]
    pub fn clk_enable_set(self) -> &'a mut W {
        self.variant(ACMP0_CLK_AW::CLK_ENABLE_SET)
    }
}
#[doc = "ADC0 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `ADC0_CLK` writer - ADC0 clock set"]
pub type ADC0_CLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSCCTL1_SET_SPEC, ADC0_CLK_AW, O>;
impl<'a, const O: u8> ADC0_CLK_W<'a, O> {
    ...
    #[inline(always)]
    pub fn clk_enable_set(self) -> &'a mut W {
        self.variant(ADC0_CLK_AW::CLK_ENABLE_SET)
    }
}
...
pub type SHSGPIO0_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL1_SET_SPEC, SHSGPIO0_CLK_AW, O>;
impl<'a, const O: u8> SHSGPIO0_CLK_W<'a, O> {
    ...
    #[inline(always)]
    pub fn clk_enable_set(self) -> &'a mut W {
        self.variant(SHSGPIO0_CLK_AW::CLK_ENABLE_SET)
    }
}
impl W {

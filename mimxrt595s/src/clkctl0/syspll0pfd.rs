...
pub struct R(crate::R<SYSPLL0PFD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SYSPLL0PFD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SYSPLL0PFD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SYSPLL0PFD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SYSPLL0PFD` writer"]
pub struct W(crate::W<SYSPLL0PFD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SYSPLL0PFD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SYSPLL0PFD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SYSPLL0PFD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PFD0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSPLL0PFD_SPEC, u8, u8, 6, O>;
...
pub enum PFD0_CLKRDY_A {
    #[doc = "0: PFD0 clock is not ready"]
    NOTREADY = 0,
    #[doc = "1: PFD0 clock is ready"]
    READY = 1,
}
...
pub type PFD0_CLKRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD0_CLKRDY_A, O>;
impl<'a, const O: u8> PFD0_CLKRDY_W<'a, O> {
    #[doc = "PFD0 clock is not ready"]
    #[inline(always)]
    pub fn notready(self) -> &'a mut W {
        self.variant(PFD0_CLKRDY_A::NOTREADY)
    }
    #[doc = "PFD0 clock is ready"]
    #[inline(always)]
...
impl PFD0_CLKGATE_R {
    ...
    pub fn variant(&self) -> PFD0_CLKGATE_A {
        match self.bits {
            false => PFD0_CLKGATE_A::NOTGATED,
            true => PFD0_CLKGATE_A::GATED,
        }
    }
    #[doc = "Checks if the value of the field is `NOTGATED`"]
    #[inline(always)]
    pub fn is_notgated(&self) -> bool {
        *self == PFD0_CLKGATE_A::NOTGATED
    }
...
pub type PFD0_CLKGATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD0_CLKGATE_A, O>;
impl<'a, const O: u8> PFD0_CLKGATE_W<'a, O> {
    #[doc = "PFD0 clock is not gated"]
    #[inline(always)]
    pub fn notgated(self) -> &'a mut W {
        self.variant(PFD0_CLKGATE_A::NOTGATED)
    }
...
pub type PFD1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSPLL0PFD_SPEC, u8, u8, 6, O>;
...
pub enum PFD1_CLKRDY_A {
    #[doc = "0: PFD1 clock is not ready"]
    NOTREADY = 0,
    #[doc = "1: PFD1 clock is ready"]
    READY = 1,
}
...
pub type PFD1_CLKRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD1_CLKRDY_A, O>;
impl<'a, const O: u8> PFD1_CLKRDY_W<'a, O> {
    #[doc = "PFD1 clock is not ready"]
    #[inline(always)]
    pub fn notready(self) -> &'a mut W {
        self.variant(PFD1_CLKRDY_A::NOTREADY)
    }
    #[doc = "PFD1 clock is ready"]
    #[inline(always)]
    pub fn ready(self) -> &'a mut W {
...
pub type PFD1_CLKGATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD1_CLKGATE_A, O>;
impl<'a, const O: u8> PFD1_CLKGATE_W<'a, O> {
    #[doc = "PFD1 clock is not gated"]
    #[inline(always)]
    pub fn notgated(self) -> &'a mut W {
        self.variant(PFD1_CLKGATE_A::NOTGATED)
    }
...
pub type PFD2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSPLL0PFD_SPEC, u8, u8, 6, O>;
...
pub enum PFD2_CLKRDY_A {
    #[doc = "0: PFD2 clock is not ready"]
    NOTREADY = 0,
    #[doc = "1: PFD2 clock is ready"]
    READY = 1,
}
...
pub type PFD2_CLKRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD2_CLKRDY_A, O>;
impl<'a, const O: u8> PFD2_CLKRDY_W<'a, O> {
    #[doc = "PFD2 clock is not ready"]
    #[inline(always)]
    pub fn notready(self) -> &'a mut W {
        self.variant(PFD2_CLKRDY_A::NOTREADY)
    }
    #[doc = "PFD2 clock is ready"]
    #[inline(always)]
    pub fn ready(self) -> &'a mut W {
...
pub type PFD2_CLKGATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD2_CLKGATE_A, O>;
impl<'a, const O: u8> PFD2_CLKGATE_W<'a, O> {
    #[doc = "PFD2 clock is not gated"]
    #[inline(always)]
    pub fn notgated(self) -> &'a mut W {
        self.variant(PFD2_CLKGATE_A::NOTGATED)
    }
...
pub type PFD3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYSPLL0PFD_SPEC, u8, u8, 6, O>;
...
pub enum PFD3_CLKRDY_A {
    #[doc = "0: PFD3 clock is not ready"]
    NOTREADY = 0,
    #[doc = "1: PFD3 clock is ready"]
    READY = 1,
}
...
pub type PFD3_CLKRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD3_CLKRDY_A, O>;
impl<'a, const O: u8> PFD3_CLKRDY_W<'a, O> {
    #[doc = "PFD3 clock is not ready"]
    #[inline(always)]
    pub fn notready(self) -> &'a mut W {
        self.variant(PFD3_CLKRDY_A::NOTREADY)
    }
    #[doc = "PFD3 clock is ready"]
    #[inline(always)]
    pub fn ready(self) -> &'a mut W {
...
pub type PFD3_CLKGATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SYSPLL0PFD_SPEC, PFD3_CLKGATE_A, O>;
impl<'a, const O: u8> PFD3_CLKGATE_W<'a, O> {
    #[doc = "PFD3 clock is not gated"]
    #[inline(always)]
    pub fn notgated(self) -> &'a mut W {
        self.variant(PFD3_CLKGATE_A::NOTGATED)
    }
...
#[doc = "System PLL0 PFD\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [syspll0pfd](index.html) module"]
pub struct SYSPLL0PFD_SPEC;
impl crate::RegisterSpec for SYSPLL0PFD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [syspll0pfd::R](R) reader structure"]
impl crate::Readable for SYSPLL0PFD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [syspll0pfd::W](W) writer structure"]
impl crate::Writable for SYSPLL0PFD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SYSPLL0PFD to value 0x8080_8080"]
impl crate::Resettable for SYSPLL0PFD_SPEC {

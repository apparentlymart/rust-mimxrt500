#[doc = "Register `CLKOUTFCLKDIV` reader"]
pub struct R(crate::R<CLKOUTFCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLKOUTFCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLKOUTFCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLKOUTFCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLKOUTFCLKDIV` writer"]
pub struct W(crate::W<CLKOUTFCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLKOUTFCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLKOUTFCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLKOUTFCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DIV` reader - Clock-Out Clock Divider Value"]
pub type DIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIV` writer - Clock-Out Clock Divider Value"]
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLKOUTFCLKDIV_SPEC, u8, u8, 8, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKOUTFCLKDIV_SPEC, RESET_A, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKOUTFCLKDIV_SPEC, HALT_A, O>;
...
pub type REQFLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLKOUTFCLKDIV_SPEC, REQFLAG_A, O>;
...
impl R {
    #[doc = "Bits 0:7 - Clock-Out Clock Divider Value"]
    #[inline(always)]
...
#[doc = "CLKOUT Functional Clock Divider\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [clkoutfclkdiv](index.html) module"]
pub struct CLKOUTFCLKDIV_SPEC;
impl crate::RegisterSpec for CLKOUTFCLKDIV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clkoutfclkdiv::R](R) reader structure"]
impl crate::Readable for CLKOUTFCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clkoutfclkdiv::W](W) writer structure"]
impl crate::Writable for CLKOUTFCLKDIV_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CLKOUTFCLKDIV to value 0x4000_0000"]
impl crate::Resettable for CLKOUTFCLKDIV_SPEC {

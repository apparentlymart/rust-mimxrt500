#[doc = "Register `PSCCTL2_SET` reader"]
pub struct R(crate::R<PSCCTL2_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSCCTL2_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSCCTL2_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSCCTL2_SET_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CT32BIT bit timer 0 clock set\n\nValue on reset: 0"]
...
#[doc = "Field `CT32BIT0_CLK` writer - CT32BIT bit timer 0 clock set"]
pub type CT32BIT0_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, CT32BIT0_CLK_AW, O>;
...
#[doc = "CT32BIT bit timer 1 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CT32BIT1_CLK` writer - CT32BIT bit timer 1 clock set"]
pub type CT32BIT1_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, CT32BIT1_CLK_AW, O>;
...
#[doc = "CT32BIT bit timer 2 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CT32BIT2_CLK` writer - CT32BIT bit timer 2 clock set"]
pub type CT32BIT2_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, CT32BIT2_CLK_AW, O>;
...
#[doc = "CT32BIT bit timer 3 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CT32BIT3_CLK` writer - CT32BIT bit timer 3 clock set"]
pub type CT32BIT3_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, CT32BIT3_CLK_AW, O>;
...
#[doc = "CT32BIT bit timer 4 clock set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CT32BIT4_CLK` writer - CT32BIT bit timer 4 clock set"]
pub type CT32BIT4_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, CT32BIT4_CLK_AW, O>;
...
#[doc = "Field `RTCLITE_CLK` reader - RTC clock control set"]
pub type RTCLITE_CLK_R = crate::BitReader<RTCLITE_CLK_A>;
#[doc = "RTC clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `RTCLITE_CLK` writer - RTC clock control set"]
pub type RTCLITE_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, RTCLITE_CLK_A, O>;
...
#[doc = "Field `MRT0_CLK` reader - Multi-Rate Timer 0 clock control set"]
pub type MRT0_CLK_R = crate::BitReader<MRT0_CLK_A>;
#[doc = "Multi-Rate Timer 0 clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MRT0_CLK_A {
    #[doc = "0: Disable Clock"]
    DISABLE = 0,
...
#[doc = "Field `MRT0_CLK` writer - Multi-Rate Timer 0 clock control set"]
pub type MRT0_CLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, MRT0_CLK_A, O>;
...
#[doc = "Field `WWDT1_CLK` reader - Watchdog Timer 1 clock control set"]
pub type WWDT1_CLK_R = crate::BitReader<WWDT1_CLK_A>;
#[doc = "Watchdog Timer 1 clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `WWDT1_CLK` writer - Watchdog Timer 1 clock control set"]
pub type WWDT1_CLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, WWDT1_CLK_A, O>;
...
#[doc = "Field `I3C0_CLK` reader - I3C0 clock control set"]
pub type I3C0_CLK_R = crate::BitReader<I3C0_CLK_A>;
#[doc = "I3C0 clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum I3C0_CLK_A {
    #[doc = "0: Disable Clock"]
    DISABLE = 0,
...
#[doc = "Field `I3C0_CLK` writer - I3C0 clock control set"]
pub type I3C0_CLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, I3C0_CLK_A, O>;
...
#[doc = "Field `I3C1_CLK` reader - I3C1 clock control set"]
pub type I3C1_CLK_R = crate::BitReader<I3C1_CLK_A>;
#[doc = "I3C1 clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum I3C1_CLK_A {
    #[doc = "0: Disable Clock"]
    DISABLE = 0,
...
#[doc = "Field `I3C1_CLK` writer - I3C1 clock control set"]
pub type I3C1_CLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, I3C1_CLK_A, O>;
...
#[doc = "Field `GPIOINTCTL_CLK` reader - PINT clock control set"]
pub type GPIOINTCTL_CLK_R = crate::BitReader<GPIOINTCTL_CLK_A>;
#[doc = "PINT clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `GPIOINTCTL_CLK` writer - PINT clock control set"]
pub type GPIOINTCTL_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, GPIOINTCTL_CLK_A, O>;
...
#[doc = "Field `PIMCTL_CLK` reader - INPUTMUX clock control set"]
pub type PIMCTL_CLK_R = crate::BitReader<PIMCTL_CLK_A>;
#[doc = "INPUTMUX clock control set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `PIMCTL_CLK` writer - INPUTMUX clock control set"]
pub type PIMCTL_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PSCCTL2_SET_SPEC, PIMCTL_CLK_A, O>;
...
#[doc = "`read()` method returns [pscctl2_set::R](R) reader structure"]
impl crate::Readable for PSCCTL2_SET_SPEC {
    type Reader = R;
}

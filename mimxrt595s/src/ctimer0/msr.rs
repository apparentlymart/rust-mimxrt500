...
pub type MATCH_SHADOW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MATCH_SHADOW` writer - Timer counter match shadow value."]
pub type MATCH_SHADOW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MSR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn match_shadow(&mut self) -> MATCH_SHADOW_W<0> {
        MATCH_SHADOW_W::new(self)
    }

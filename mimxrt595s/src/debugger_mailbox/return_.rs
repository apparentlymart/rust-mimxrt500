...
#[doc = "Field `RETURN` reader - Return Value"]
pub type RETURN_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RETURN` writer - Return Value"]
pub type RETURN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RETURN_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Return Value"]
    #[inline(always)]
    pub fn return_(&self) -> RETURN_R {
        RETURN_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Return Value"]
    #[inline(always)]
    #[must_use]
    pub fn return_(&mut self) -> RETURN_W<0> {
        RETURN_W::new(self)
    }

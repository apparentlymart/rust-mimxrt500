...
#[doc = "Field `VALIDPENDING` reader - Valid pending flag for this channel."]
pub type VALIDPENDING_R = crate::BitReader<VALIDPENDING_A>;
#[doc = "Valid pending flag for this channel.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VALIDPENDING_A {
    #[doc = "0: No effect on DMA operation."]
    NO_EFFECT = 0,
    #[doc = "1: Valid pending."]
    VALID_PENDING = 1,
}
...
#[doc = "Field `TRIG` reader - Trigger flag."]

...
#[doc = "Field `CFGVALID` reader - Configuration Valid flag."]
...
#[doc = "Field `CFGVALID` writer - Configuration Valid flag."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RELOAD_A {
    #[doc = "0: Disabled. The channels' control structure should not be reloaded when the current descriptor is exhausted."]
    DISABLED = 0,
    #[doc = "1: Enabled. The channels' control structure should be reloaded when the current descriptor is exhausted."]
    ENABLED = 1,
}
...
impl<'a, const O: u8> RELOAD_W<'a, O> {
    #[doc = "Disabled. The channels' control structure should not be reloaded when the current descriptor is exhausted."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(RELOAD_A::DISABLED)
    }
    #[doc = "Enabled. The channels' control structure should be reloaded when the current descriptor is exhausted."]
    #[inline(always)]
...
#[doc = "Field `SETINTA` reader - Set Interrupt flag A for channel."]
pub type SETINTA_R = crate::BitReader<SETINTA_A>;
#[doc = "Set Interrupt flag A for channel.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SETINTA_A {
    #[doc = "0: No effect."]
    NO_EFFECT = 0,
...
#[doc = "Field `SETINTA` writer - Set Interrupt flag A for channel."]
...
#[doc = "Field `SETINTB` reader - Set Interrupt flag B for channel."]
pub type SETINTB_R = crate::BitReader<SETINTB_A>;
#[doc = "Set Interrupt flag B for channel.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SETINTB_A {
    #[doc = "0: No effect."]
    NO_EFFECT = 0,
...
#[doc = "Field `SETINTB` writer - Set Interrupt flag B for channel."]
...
#[doc = "Field `SRCINC` reader - Source address increment"]
...
#[doc = "Field `SRCINC` writer - Source address increment"]
...
#[doc = "Field `DSTINC` reader - Destination address increment"]
...
#[doc = "Field `DSTINC` writer - Destination address increment"]
...
#[doc = "Field `XFERCOUNT` reader - Total number of transfers to be performed, minus 1 encoded."]
pub type XFERCOUNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `XFERCOUNT` writer - Total number of transfers to be performed, minus 1 encoded."]
...
impl R {
    ...
    #[doc = "Bit 4 - Set Interrupt flag A for channel."]
    #[inline(always)]
    pub fn setinta(&self) -> SETINTA_R {
        SETINTA_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Set Interrupt flag B for channel."]
    #[inline(always)]
    ...
    #[doc = "Bits 12:13 - Source address increment"]
    #[inline(always)]
    pub fn srcinc(&self) -> SRCINC_R {
        SRCINC_R::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bits 14:15 - Destination address increment"]
    #[inline(always)]
    pub fn dstinc(&self) -> DSTINC_R {
        DSTINC_R::new(((self.bits >> 14) & 3) as u8)
    }
    #[doc = "Bits 16:25 - Total number of transfers to be performed, minus 1 encoded."]
    #[inline(always)]

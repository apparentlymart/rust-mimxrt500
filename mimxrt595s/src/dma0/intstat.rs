...
pub enum ACTIVEINT_A {
    #[doc = "0: No enabled interrupts are pending."]
    NOT_PENDING = 0,
    #[doc = "1: At least one enabled interrupt is pending."]
    PENDING = 1,
}
...
pub enum ACTIVEERRINT_A {
    #[doc = "0: No error interrupts are pending."]
    NOT_PENDING = 0,
    #[doc = "1: At least one error interrupt is pending."]
    PENDING = 1,
}

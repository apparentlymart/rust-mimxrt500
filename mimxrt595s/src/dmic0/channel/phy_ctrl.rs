...
pub enum PHY_HALF_A {
    ...
    STANDARD = 0,
    #[doc = "1: Use half rate sampling. The clock to the DMIC is sent at half the rate that the decimator is providing."]
    HALF_RATE = 1,
}
...
impl<'a, const O: u8> PHY_HALF_W<'a, O> {
    ...
    #[doc = "Use half rate sampling. The clock to the DMIC is sent at half the rate that the decimator is providing."]
    #[inline(always)]

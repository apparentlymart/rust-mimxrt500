...
#[doc = "Field `HPFS` reader - The HPFS field chooses the High Pass filter in first part of HWVAD."]
pub type HPFS_R = crate::FieldReader<u8, HPFS_A>;
#[doc = "The HPFS field chooses the High Pass filter in first part of HWVAD.\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum HPFS_A {
    #[doc = "0: Bypass"]
    BYPASS = 0,
    #[doc = "1: High Pass 1750 Hz"]
    HIGH_PASS_1750HZ = 1,
    #[doc = "2: High Pass 215 Hz"]
    HIGH_PASS_215HZ = 2,
}
...
#[doc = "Field `HPFS` writer - The HPFS field chooses the High Pass filter in first part of HWVAD."]
...
impl R {
    #[doc = "Bits 0:1 - The HPFS field chooses the High Pass filter in first part of HWVAD."]
    #[inline(always)]

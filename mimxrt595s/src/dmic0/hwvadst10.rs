...
pub enum ST10_A {
    ...
    NORMAL = 0,
    #[doc = "1: Reset internal interrupt flag by writing a '1' (stage 1) pulse."]
    RESET = 1,
}
...
impl<'a, const O: u8> ST10_W<'a, O> {
    ...
    #[doc = "Reset internal interrupt flag by writing a '1' (stage 1) pulse."]
    #[inline(always)]

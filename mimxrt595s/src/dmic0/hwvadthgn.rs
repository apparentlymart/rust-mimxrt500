...
#[doc = "Field `THGN` reader - Gain Factor for Noise Estimator"]
pub type THGN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `THGN` writer - Gain Factor for Noise Estimator"]
pub type THGN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HWVADTHGN_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:3 - Gain Factor for Noise Estimator"]
    #[inline(always)]

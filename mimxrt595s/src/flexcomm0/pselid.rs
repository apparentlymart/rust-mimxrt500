...
#[doc = "Field `PERSEL` reader - Peripheral Select"]
...
#[doc = "Field `PERSEL` writer - Peripheral Select"]
...
#[doc = "Field `LOCK` reader - Lock the peripheral select"]
pub type LOCK_R = crate::BitReader<LOCK_A>;
#[doc = "Lock the peripheral select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LOCK_A {
    #[doc = "0: Peripheral select can be changed by software."]
    UNLOCKED = 0,
    #[doc = "1: Peripheral select is locked and cannot be changed until this Flexcomm module or the entire device is reset."]
    LOCKED = 1,
}
...
#[doc = "Field `LOCK` writer - Lock the peripheral select"]
...
impl<'a, const O: u8> LOCK_W<'a, O> {
    ...
    #[doc = "Peripheral select is locked and cannot be changed until this Flexcomm module or the entire device is reset."]
    #[inline(always)]
    pub fn locked(self) -> &'a mut W {
        self.variant(LOCK_A::LOCKED)
    }
}
#[doc = "Field `USARTPRESENT` reader - USART present indicator"]
pub type USARTPRESENT_R = crate::BitReader<USARTPRESENT_A>;
#[doc = "USART present indicator\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USARTPRESENT_A {
    #[doc = "0: This Flexcomm module does not include the USART function."]
    NOT_PRESENT = 0,
    #[doc = "1: This Flexcomm module includes the USART function."]
    PRESENT = 1,
}
...
#[doc = "Field `SPIPRESENT` reader - SPI present indicator"]
pub type SPIPRESENT_R = crate::BitReader<SPIPRESENT_A>;
#[doc = "SPI present indicator\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPIPRESENT_A {
    #[doc = "0: This Flexcomm module does not include the SPI function."]
    NOT_PRESENT = 0,
    #[doc = "1: This Flexcomm module includes the SPI function."]
    PRESENT = 1,
}
...
#[doc = "Field `I2CPRESENT` reader - I2C present indicator"]
pub type I2CPRESENT_R = crate::BitReader<I2CPRESENT_A>;
#[doc = "I2C present indicator\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum I2CPRESENT_A {
    #[doc = "0: I2C Not Present"]
    NOT_PRESENT = 0,
    #[doc = "1: I2C Present"]
    PRESENT = 1,
}

...
pub type SHIFTBUFNIS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SHIFTBUFNIS` writer - Shift Buffer"]
pub type SHIFTBUFNIS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SHIFTBUFNIS_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Shift Buffer"]
    #[inline(always)]
    pub fn shiftbufnis(&self) -> SHIFTBUFNIS_R {
        SHIFTBUFNIS_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Shift Buffer"]
    #[inline(always)]
    #[must_use]
    pub fn shiftbufnis(&mut self) -> SHIFTBUFNIS_W<0> {
        SHIFTBUFNIS_W::new(self)
    }
...
#[doc = "`reset()` method sets SHIFTBUFNIS[%s]
to value 0"]

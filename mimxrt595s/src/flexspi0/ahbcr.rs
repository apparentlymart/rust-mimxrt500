...
#[doc = "Field `RESUMEDISABLE` reader - AHB Read Resume Disable"]
pub type RESUMEDISABLE_R = crate::BitReader<RESUMEDISABLE_A>;
#[doc = "AHB Read Resume Disable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RESUMEDISABLE_A {
    #[doc = "0: Suspended AHB read prefetch will start to resume when AHB is IDLE"]
    VAL0 = 0,
    #[doc = "1: Suspended AHB read prefetch will not resume once it is aborted"]
    VAL1 = 1,
}
impl From<RESUMEDISABLE_A> for bool {
    #[inline(always)]
    fn from(variant: RESUMEDISABLE_A) -> Self {
        variant as u8 != 0
    }
}
impl RESUMEDISABLE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> RESUMEDISABLE_A {
        match self.bits {
            false => RESUMEDISABLE_A::VAL0,
            true => RESUMEDISABLE_A::VAL1,
        }
    }
    #[doc = "Checks if the value of the field is `VAL0`"]
    #[inline(always)]
    pub fn is_val0(&self) -> bool {
        *self == RESUMEDISABLE_A::VAL0
    }
    #[doc = "Checks if the value of the field is `VAL1`"]
    #[inline(always)]
    pub fn is_val1(&self) -> bool {
        *self == RESUMEDISABLE_A::VAL1
    }
}
#[doc = "Field `RESUMEDISABLE` writer - AHB Read Resume Disable"]
pub type RESUMEDISABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, AHBCR_SPEC, RESUMEDISABLE_A, O>;
impl<'a, const O: u8> RESUMEDISABLE_W<'a, O> {
    #[doc = "Suspended AHB read prefetch will start to resume when AHB is IDLE"]
    #[inline(always)]
    pub fn val0(self) -> &'a mut W {
        self.variant(RESUMEDISABLE_A::VAL0)
    }
    #[doc = "Suspended AHB read prefetch will not resume once it is aborted"]
    #[inline(always)]
    pub fn val1(self) -> &'a mut W {
        self.variant(RESUMEDISABLE_A::VAL1)
    }
}
...
pub enum READSZALIGN_A {
    #[doc = "0: AHB read size will be decided by other register setting like PREFETCH_EN,OTFAD_EN..."]
    VAL0 = 0,
...
impl R {
    ...
    #[doc = "Bit 7 - AHB Read Resume Disable"]
    #[inline(always)]
    pub fn resumedisable(&self) -> RESUMEDISABLE_R {
        RESUMEDISABLE_R::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn resumedisable(&mut self) -> RESUMEDISABLE_W<7> {
        RESUMEDISABLE_W::new(self)
    }
    #[doc = "Bit 10 - AHB Read Size Alignment"]
    #[inline(always)]
    #[must_use]

...
pub type BUFSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF5CR0_SPEC, u8, u8, 8, O>;
...
#[doc = "`reset()` method sets AHBRXBUF5CR0 to value 0x8005_0010"]
impl crate::Resettable for AHBRXBUF5CR0_SPEC {
    const RESET_VALUE: Self::Ux = 0x8005_0010;
}

...
pub type BUFSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF6CR0_SPEC, u8, u8, 8, O>;
...
#[doc = "`reset()` method sets AHBRXBUF6CR0 to value 0x8006_0010"]
impl crate::Resettable for AHBRXBUF6CR0_SPEC {
    const RESET_VALUE: Self::Ux = 0x8006_0010;
}

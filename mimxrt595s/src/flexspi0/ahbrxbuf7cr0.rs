...
pub type BUFSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF7CR0_SPEC, u8, u8, 8, O>;
...
#[doc = "`reset()` method sets AHBRXBUF7CR0 to value 0x8007_0010"]
impl crate::Resettable for AHBRXBUF7CR0_SPEC {
    const RESET_VALUE: Self::Ux = 0x8007_0010;
}

...
#[doc = "Field `AHBBUSERROR` reader - AHB Bus timeout or AHB bus illegal access Flash during OTFAD key blob processing interrupt."]
pub type AHBBUSERROR_R = crate::BitReader<bool>;
#[doc = "Field `AHBBUSERROR` writer - AHB Bus timeout or AHB bus illegal access Flash during OTFAD key blob processing interrupt."]
pub type AHBBUSERROR_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTR_SPEC, bool, O>;
...
#[doc = "Field `KEYDONE` reader - OTFAD key blob processing done interrupt."]
pub type KEYDONE_R = crate::BitReader<bool>;
#[doc = "Field `KEYDONE` writer - OTFAD key blob processing done interrupt."]
pub type KEYDONE_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTR_SPEC, bool, O>;
#[doc = "Field `KEYERROR` reader - OTFAD key blob processing error interrupt."]
pub type KEYERROR_R = crate::BitReader<bool>;
impl R {
    ...
    #[doc = "Bit 10 - AHB Bus timeout or AHB bus illegal access Flash during OTFAD key blob processing interrupt."]
    #[inline(always)]
    pub fn ahbbuserror(&self) -> AHBBUSERROR_R {
        AHBBUSERROR_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    #[doc = "Bit 12 - OTFAD key blob processing done interrupt."]
    #[inline(always)]
    pub fn keydone(&self) -> KEYDONE_R {
        KEYDONE_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - OTFAD key blob processing error interrupt."]
    #[inline(always)]
    pub fn keyerror(&self) -> KEYERROR_R {
        KEYERROR_R::new(((self.bits >> 13) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - IP triggered Command Sequences Execution finished interrupt. This interrupt is also generated when there is IPCMDGE or IPCMDERR interrupt generated."]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahbbuserror(&mut self) -> AHBBUSERROR_W<10> {
        AHBBUSERROR_W::new(self)
    }
    #[doc = "Bit 11 - Sequence execution timeout interrupt."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn keydone(&mut self) -> KEYDONE_W<12> {
        KEYDONE_W::new(self)
    }
...
impl crate::Writable for INTR_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x1fff;
}

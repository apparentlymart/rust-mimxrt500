...
pub type BUFSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF0CR0_SPEC, u16, u16, 9, O>;
...
pub type PRIORITY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF0CR0_SPEC, u8, u8, 3, O>;
...
pub type PREFETCHEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, AHBRXBUF0CR0_SPEC, PREFETCHEN_A, O>;

...
#[doc = "Field `AHBBUSTIMEOUTEN` reader - AHB Bus timeout interrupt."]
pub type AHBBUSTIMEOUTEN_R = crate::BitReader<AHBBUSTIMEOUTEN_A>;
#[doc = "AHB Bus timeout interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AHBBUSTIMEOUTEN_A {
    #[doc = "0: Disable interrupt or no impact"]
    VALUE0 = 0,
    #[doc = "1: Enable interrupt"]
    VALUE1 = 1,
}
impl From<AHBBUSTIMEOUTEN_A> for bool {
    #[inline(always)]
    fn from(variant: AHBBUSTIMEOUTEN_A) -> Self {
        variant as u8 != 0
    }
}
impl AHBBUSTIMEOUTEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> AHBBUSTIMEOUTEN_A {
        match self.bits {
            false => AHBBUSTIMEOUTEN_A::VALUE0,
            true => AHBBUSTIMEOUTEN_A::VALUE1,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE0`"]
    #[inline(always)]
    pub fn is_value0(&self) -> bool {
        *self == AHBBUSTIMEOUTEN_A::VALUE0
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == AHBBUSTIMEOUTEN_A::VALUE1
    }
}
#[doc = "Field `AHBBUSTIMEOUTEN` writer - AHB Bus timeout interrupt."]
pub type AHBBUSTIMEOUTEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTEN_SPEC, AHBBUSTIMEOUTEN_A, O>;
impl<'a, const O: u8> AHBBUSTIMEOUTEN_W<'a, O> {
    #[doc = "Disable interrupt or no impact"]
    #[inline(always)]
    pub fn value0(self) -> &'a mut W {
        self.variant(AHBBUSTIMEOUTEN_A::VALUE0)
    }
    #[doc = "Enable interrupt"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(AHBBUSTIMEOUTEN_A::VALUE1)
    }
}

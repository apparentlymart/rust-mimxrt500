...
pub enum MSTEN_A {
    #[doc = "0: Disabled. The I2C Master function is disabled. When disabled, the Master configuration settings are not changed, but the Master function is internally reset."]
    DISABLED = 0,
...
impl<'a, const O: u8> MSTEN_W<'a, O> {
    #[doc = "Disabled. The I2C Master function is disabled. When disabled, the Master configuration settings are not changed, but the Master function is internally reset."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SLVEN_A {
    #[doc = "0: Disabled. The I2C slave function is disabled. When disabled, the Slave configuration settings are not changed, but the Slave function is internally reset."]
    DISABLED = 0,
...
impl<'a, const O: u8> SLVEN_W<'a, O> {
    #[doc = "Disabled. The I2C slave function is disabled. When disabled, the Slave configuration settings are not changed, but the Slave function is internally reset."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
#[doc = "Field `MONEN` reader - Monitor Enable"]
pub type MONEN_R = crate::BitReader<MONEN_A>;
#[doc = "Monitor Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MONEN_A {
    #[doc = "0: Disabled. The I2C Monitor function is disabled. When disabled, the Monitor function configuration settings are not changed, but the Monitor function is internally reset."]
    DISABLED = 0,
...
#[doc = "Field `MONEN` writer - Monitor Enable"]
pub type MONEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, MONEN_A, O>;
impl<'a, const O: u8> MONEN_W<'a, O> {
    #[doc = "Disabled. The I2C Monitor function is disabled. When disabled, the Monitor function configuration settings are not changed, but the Monitor function is internally reset."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
#[doc = "Field `TIMEOUTEN` reader - I2C bus Time-out Enable"]
pub type TIMEOUTEN_R = crate::BitReader<TIMEOUTEN_A>;
#[doc = "I2C bus Time-out Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIMEOUTEN_A {
    #[doc = "0: Disabled. The time-out function is disabled. When disabled, the time-out function is internally reset."]
    DISABLED = 0,
    #[doc = "1: Enabled. The time-out function is enabled. Both types of time-out flags will be generated and will cause interrupts if those flags are enabled. Typically, only one time-out flag will be used in a system."]
    ENABLED = 1,
}
...
#[doc = "Field `TIMEOUTEN` writer - I2C bus Time-out Enable"]
pub type TIMEOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, TIMEOUTEN_A, O>;
impl<'a, const O: u8> TIMEOUTEN_W<'a, O> {
    #[doc = "Disabled. The time-out function is disabled. When disabled, the time-out function is internally reset."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(TIMEOUTEN_A::DISABLED)
    }
    #[doc = "Enabled. The time-out function is enabled. Both types of time-out flags will be generated and will cause interrupts if those flags are enabled. Typically, only one time-out flag will be used in a system."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
pub enum MONCLKSTR_A {
    #[doc = "0: Disabled. The Monitor function will not perform clock stretching. Software or DMA may not always be able to read data provided by the Monitor function before it (the data) is overwritten. This mode can be used when non-invasive monitoring is critical."]
    DISABLED = 0,
    #[doc = "1: Enabled. The Monitor function will perform clock stretching, to ensure that the software or DMA can read all incoming data supplied by the Monitor function."]
    ENABLED = 1,
}
...
impl<'a, const O: u8> MONCLKSTR_W<'a, O> {
    #[doc = "Disabled. The Monitor function will not perform clock stretching. Software or DMA may not always be able to read data provided by the Monitor function before it (the data) is overwritten. This mode can be used when non-invasive monitoring is critical."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(MONCLKSTR_A::DISABLED)
    }
    #[doc = "Enabled. The Monitor function will perform clock stretching, to ensure that the software or DMA can read all incoming data supplied by the Monitor function."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(MONCLKSTR_A::ENABLED)
    }
}
#[doc = "Field `HSCAPABLE` reader - High Speed mode Capable enable"]
pub type HSCAPABLE_R = crate::BitReader<HSCAPABLE_A>;
#[doc = "High Speed mode Capable enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HSCAPABLE_A {
    #[doc = "0: Fast mode Plus enable"]
    FAST_MODE_PLUS = 0,
    #[doc = "1: High Speed mode enable"]
    HIGH_SPEED = 1,
}
...
#[doc = "Field `HSCAPABLE` writer - High Speed mode Capable enable"]
...
impl R {
    ...
    #[doc = "Bit 5 - High Speed mode Capable enable"]
    #[inline(always)]

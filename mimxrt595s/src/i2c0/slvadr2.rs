...
#[doc = "Field `SLVADR` reader - Slave Address."]
pub type SLVADR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SLVADR` writer - Slave Address."]
pub type SLVADR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SLVADR2_SPEC, u8, u8, 7, O>;
#[doc = "Field `AUTONACK` reader - Automatic NACK operation"]
pub type AUTONACK_R = crate::BitReader<AUTONACK_A>;
#[doc = "Automatic NACK operation\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AUTONACK_A {
    #[doc = "0: Normal operation, matching I2C addresses are not ignored."]
    NORMAL = 0,
    #[doc = "1: Automatic-only mode. All incoming addresses are ignored (NACKed), unless AUTOACK is set, and the address matches SLVADRn, and AUTOMATCHREAD matches the direction."]
    AUTOMATIC = 1,
}
...
#[doc = "Field `AUTONACK` writer - Automatic NACK operation"]
pub type AUTONACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, SLVADR2_SPEC, AUTONACK_A, O>;
impl<'a, const O: u8> AUTONACK_W<'a, O> {
    ...
    #[doc = "Automatic-only mode. All incoming addresses are ignored (NACKed), unless AUTOACK is set, and the address matches SLVADRn, and AUTOMATCHREAD matches the direction."]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 15 - Automatic NACK operation"]
    #[inline(always)]

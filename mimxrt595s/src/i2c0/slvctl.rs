...
pub enum SLVCONTINUE_A {
    #[doc = "0: No effect"]
    NO_EFFECT = 0,
    #[doc = "1: Continue. Informs the Slave function to continue to the next operation, by clearing the STAT\\[SLVPENDING\\]
flag. This must be done after writing transmit data, reading received data, or any other housekeeping related to the next bus operation. Automatic Operation has different requirements. SLVCONTINUE should not be set unless SLVPENDING = 1."]
    CONTINUE = 1,
}
...
impl<'a, const O: u8> SLVCONTINUE_W<'a, O> {
    ...
    #[doc = "Continue. Informs the Slave function to continue to the next operation, by clearing the STAT\\[SLVPENDING\\]
flag. This must be done after writing transmit data, reading received data, or any other housekeeping related to the next bus operation. Automatic Operation has different requirements. SLVCONTINUE should not be set unless SLVPENDING = 1."]
    #[inline(always)]
...
pub enum SLVNACK_A {
    #[doc = "0: No effect"]
    NO_EFFECT = 0,
    #[doc = "1: NACK. Causes the Slave function to NACK the master when the slave is receiving data from the master (in Slave Receiver mode)."]
    NACK = 1,
}
...
impl<'a, const O: u8> SLVNACK_W<'a, O> {
    ...
    #[doc = "NACK. Causes the Slave function to NACK the master when the slave is receiving data from the master (in Slave Receiver mode)."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AUTOACK_A {
    #[doc = "0: Normal, non-automatic operation. If AUTONACK = 0, then a SlvPending interrupt is generated when a matching address is received. If AUTONACK = 1, then received addresses are NACKed (ignored)."]
    NORMAL = 0,
    #[doc = "1: A header with matching SLVADR0 and matching direction as set by AUTOMATCHREAD will be ACKed immediately, allowing the master to move on to the data bytes. If the address matches SLVADR0, but the direction does not match AUTOMATCHREAD, then the behavior will depend on the SLVADR0\\[AUTONACK\\]
bit: if AUTONACK is set, then it will be Nacked; if AUTONACK is clear, then a SlvPending interrupt is generated."]
    AUTOMATIC_ACK = 1,
}
...
impl<'a, const O: u8> AUTOACK_W<'a, O> {
    #[doc = "Normal, non-automatic operation. If AUTONACK = 0, then a SlvPending interrupt is generated when a matching address is received. If AUTONACK = 1, then received addresses are NACKed (ignored)."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(AUTOACK_A::NORMAL)
    }
    #[doc = "A header with matching SLVADR0 and matching direction as set by AUTOMATCHREAD will be ACKed immediately, allowing the master to move on to the data bytes. If the address matches SLVADR0, but the direction does not match AUTOMATCHREAD, then the behavior will depend on the SLVADR0\\[AUTONACK\\]
bit: if AUTONACK is set, then it will be Nacked; if AUTONACK is clear, then a SlvPending interrupt is generated."]
    #[inline(always)]
...
#[doc = "Field `AUTOMATCHREAD` reader - Automatic Match Read"]
pub type AUTOMATCHREAD_R = crate::BitReader<AUTOMATCHREAD_A>;
#[doc = "Automatic Match Read\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum AUTOMATCHREAD_A {
    #[doc = "0: In Automatic Mode, the expected next operation is an I2C write."]
    I2C_WRITE = 0,
    #[doc = "1: In Automatic Mode, the expected next operation is an I2C read."]
    I2C_READ = 1,
}
...
#[doc = "Field `AUTOMATCHREAD` writer - Automatic Match Read"]
...
impl<'a, const O: u8> AUTOMATCHREAD_W<'a, O> {
    #[doc = "In Automatic Mode, the expected next operation is an I2C write."]
    #[inline(always)]
    pub fn i2c_write(self) -> &'a mut W {
        self.variant(AUTOMATCHREAD_A::I2C_WRITE)
    }
    #[doc = "In Automatic Mode, the expected next operation is an I2C read."]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 8 - Automatic Acknowledge"]
    #[inline(always)]
    pub fn autoack(&self) -> AUTOACK_R {
        AUTOACK_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Automatic Match Read"]
    #[inline(always)]

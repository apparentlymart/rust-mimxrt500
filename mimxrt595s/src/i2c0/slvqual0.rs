...
#[doc = "Field `SLVQUAL0` reader - Slave address Qualifier for address 0"]
pub type SLVQUAL0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SLVQUAL0` writer - Slave address Qualifier for address 0"]
...
impl R {
    ...
    #[doc = "Bits 1:7 - Slave address Qualifier for address 0"]
    #[inline(always)]

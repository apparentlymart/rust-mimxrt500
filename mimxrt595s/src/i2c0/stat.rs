...
pub enum MSTPENDING_A {
    ...
    IN_PROGRESS = 0,
    #[doc = "1: Pending. The Master function needs software service or is in the idle state. If the master is not in the idle state, then the master is waiting to receive or transmit data, or is waiting for the NACK bit."]
    PENDING = 1,
}
...
#[doc = "Field `MSTSTATE` reader - Master State code"]
pub type MSTSTATE_R = crate::FieldReader<u8, MSTSTATE_A>;
#[doc = "Master State code\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum MSTSTATE_A {
    #[doc = "0: Idle. The Master function is available to be used for a new transaction."]
    IDLE = 0,
    #[doc = "1: Receive ready. Received data is available (in Master Receiver mode). Address plus Read was previously sent and Acknowledged by a slave."]
    RECEIVE_READY = 1,
    #[doc = "2: Transmit ready. Data can be transmitted (in Master Transmitter mode). Address plus Write was previously sent and Acknowledged by a slave."]
    TRANSMIT_READY = 2,
...
pub enum MSTARBLOSS_A {
    ...
    NO_LOSS = 0,
    #[doc = "1: Arbitration loss. The Master function has experienced an Arbitration Loss. At this point, the Master function has already stopped driving the bus and has gone into an idle state. Software can respond by doing nothing, or by sending a Start (to attempt to gain control of the bus when the bus next becomes idle)."]
    ARBITRATION_LOSS = 1,
}
...
#[doc = "Field `MSTARBLOSS` writer - Master Arbitration Loss flag"]
...
pub enum MSTSTSTPERR_A {
    ...
    NO_ERROR = 0,
    #[doc = "1: The Master function has experienced a Start/Stop Error. A Start or Stop was detected at a time when Start or Stop is not allowed by the I2C specification. The Master interface has stopped driving the bus and gone into an idle state; no action is required. A request for a Start could be made, or software could attempt to make sure that the bus has not stalled."]
    ERROR = 1,
}
...
#[doc = "Field `MSTSTSTPERR` writer - Master Start/Stop Error flag"]
...
impl<'a, const O: u8> MSTSTSTPERR_W<'a, O> {
    ...
    #[doc = "The Master function has experienced a Start/Stop Error. A Start or Stop was detected at a time when Start or Stop is not allowed by the I2C specification. The Master interface has stopped driving the bus and gone into an idle state; no action is required. A request for a Start could be made, or software could attempt to make sure that the bus has not stalled."]
    #[inline(always)]
...
pub enum SLVPENDING_A {
    #[doc = "0: In progress. The Slave function does not currently need software service."]
    IN_PROGRESS = 0,
    #[doc = "1: Pending. The Slave function needs software service. Information about what is needed is in the Slave state field (SLVSTATE)."]
    PENDING = 1,
}
...
#[doc = "Field `SLVSTATE` reader - Slave State"]
pub type SLVSTATE_R = crate::FieldReader<u8, SLVSTATE_A>;
#[doc = "Slave State\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum SLVSTATE_A {
    #[doc = "0: Slave address. Address plus R/W received. At least one of the 4 slave addresses has been matched by hardware."]
    SLAVE_ADDRESS = 0,
    #[doc = "1: Slave receive. Received data is available (in Slave Receiver mode)."]
    SLAVE_RECEIVE = 1,
    #[doc = "2: Slave transmit. Data can be transmitted (in Slave Transmitter mode)."]
    SLAVE_TRANSMIT = 2,
}
...
#[doc = "Field `SLVNOTSTR` reader - Slave Not Stretching"]
pub type SLVNOTSTR_R = crate::BitReader<SLVNOTSTR_A>;
#[doc = "Slave Not Stretching\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SLVNOTSTR_A {
    #[doc = "0: Stretching. The slave function is currently stretching the I2C bus clock. Deep-Sleepmode cannot be entered at this time."]
    STRETCHING = 0,
    #[doc = "1: Not stretching. The slave function is not currently stretching the I2C bus clock. Deep-sleep mode can be entered at this time."]
    NOT_STRETCHING = 1,
}
...
#[doc = "Field `SLVIDX` reader - Slave address match Index T"]
pub type SLVIDX_R = crate::FieldReader<u8, SLVIDX_A>;
#[doc = "Slave address match Index T\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum SLVIDX_A {
...
#[doc = "Field `SLVSEL` reader - Slave selected flag"]
pub type SLVSEL_R = crate::BitReader<SLVSEL_A>;
#[doc = "Slave selected flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SLVSEL_A {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SLVDESEL_A {
    #[doc = "0: Not deselected. The Slave function has not become deselected. This does not mean that the Slave is currently selected. That information is in the SLVSEL flag."]
    NOT_DESELECTED = 0,
    #[doc = "1: Deselected. The Slave function has become deselected. This is specifically caused by the SLVSEL flag changing from 1 to 0. See SLVSEL for details about when that event occurs."]
    DESELECTED = 1,
}
...
#[doc = "Field `SLVDESEL` writer - Slave Deselected flag"]
pub type SLVDESEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, STAT_SPEC, SLVDESEL_A, O>;
impl<'a, const O: u8> SLVDESEL_W<'a, O> {
    #[doc = "Not deselected. The Slave function has not become deselected. This does not mean that the Slave is currently selected. That information is in the SLVSEL flag."]
    #[inline(always)]
    pub fn not_deselected(self) -> &'a mut W {
        self.variant(SLVDESEL_A::NOT_DESELECTED)
    }
    #[doc = "Deselected. The Slave function has become deselected. This is specifically caused by the SLVSEL flag changing from 1 to 0. See SLVSEL for details about when that event occurs."]
    #[inline(always)]
...
pub enum MONOV_A {
    ...
    NO_OVERRUN = 0,
    #[doc = "1: Overrun. A Monitor data overrun has occurred. An overrun can only happen when Monitor clock stretching not enabled via the CFG\\[MONCLKSTR\\]
bit. Writing 1 to MONOV bit clears the MONOV flag."]
    OVERRUN = 1,
}
...
impl<'a, const O: u8> MONOV_W<'a, O> {
    ...
    #[doc = "Overrun. A Monitor data overrun has occurred. An overrun can only happen when Monitor clock stretching not enabled via the CFG\\[MONCLKSTR\\]
bit. Writing 1 to MONOV bit clears the MONOV flag."]
    #[inline(always)]
...
#[doc = "Field `MONACTIVE` reader - Monitor Active flag"]
pub type MONACTIVE_R = crate::BitReader<MONACTIVE_A>;
#[doc = "Monitor Active flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MONIDLE_A {
    #[doc = "0: Not idle. The I2C bus is not idle, or MONIDLE flag has been cleared by software."]
    NOT_IDLE = 0,
    #[doc = "1: Idle. The I2C bus has gone idle at least once, since the last time MONIDLE flag was cleared by software."]
    IDLE = 1,
}
...
#[doc = "Field `MONIDLE` writer - Monitor Idle flag"]
pub type MONIDLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, STAT_SPEC, MONIDLE_A, O>;
impl<'a, const O: u8> MONIDLE_W<'a, O> {
    #[doc = "Not idle. The I2C bus is not idle, or MONIDLE flag has been cleared by software."]
    #[inline(always)]
    pub fn not_idle(self) -> &'a mut W {
        self.variant(MONIDLE_A::NOT_IDLE)
    }
    #[doc = "Idle. The I2C bus has gone idle at least once, since the last time MONIDLE flag was cleared by software."]
    #[inline(always)]
...
#[doc = "Field `EVENTTIMEOUT` writer - Event Time-out Interrupt flag"]
...
#[doc = "Field `SCLTIMEOUT` writer - SCL Time-out Interrupt flag"]
...
impl R {
    ...
    #[doc = "Bits 1:3 - Master State code"]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - Monitor Active flag"]
    #[inline(always)]

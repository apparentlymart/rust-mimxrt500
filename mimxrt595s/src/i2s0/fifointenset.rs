...
#[doc = "Field `TXERR` reader - Transmit Error Interrupt"]
pub type TXERR_R = crate::BitReader<TXERR_A>;
#[doc = "Transmit Error Interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TXERR_A {
    #[doc = "0: Disabled. No interrupt generates for a transmit error."]
    DISABLED = 0,
    #[doc = "1: Enabled. An interrupt generates when a transmit error occurs."]
    ENABLED = 1,
}
...
#[doc = "Field `TXERR` writer - Transmit Error Interrupt"]
pub type TXERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, FIFOINTENSET_SPEC, TXERR_A, O>;
impl<'a, const O: u8> TXERR_W<'a, O> {
    #[doc = "Disabled. No interrupt generates for a transmit error."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(TXERR_A::DISABLED)
    }
    #[doc = "Enabled. An interrupt generates when a transmit error occurs."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(TXERR_A::ENABLED)
    }
}
#[doc = "Field `RXERR` reader - Receive Error Interrupt"]
pub type RXERR_R = crate::BitReader<RXERR_A>;
#[doc = "Receive Error Interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RXERR_A {
    #[doc = "0: Disabled"]
    DISABLED = 0,
...
#[doc = "Field `RXERR` writer - Receive Error Interrupt"]
...
#[doc = "Field `TXLVL` reader - Transmit Level Interrupt"]
pub type TXLVL_R = crate::BitReader<TXLVL_A>;
#[doc = "Transmit Level Interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TXLVL_A {
    #[doc = "0: Disabled"]
    DISABLED = 0,
...
#[doc = "Field `TXLVL` writer - Transmit Level Interrupt"]
...
#[doc = "Field `RXLVL` reader - Receive Level Interrupt"]
pub type RXLVL_R = crate::BitReader<RXLVL_A>;
#[doc = "Receive Level Interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RXLVL_A {
    #[doc = "0: Disabled"]
    DISABLED = 0,
...
#[doc = "Field `RXLVL` writer - Receive Level Interrupt"]
...
impl R {
    #[doc = "Bit 0 - Transmit Error Interrupt"]
    #[inline(always)]
    pub fn txerr(&self) -> TXERR_R {
        TXERR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Receive Error Interrupt"]
    #[inline(always)]
    pub fn rxerr(&self) -> RXERR_R {
        RXERR_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Transmit Level Interrupt"]
    #[inline(always)]
    pub fn txlvl(&self) -> TXLVL_R {
        TXLVL_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Receive Level Interrupt"]
    #[inline(always)]

#[doc = "Register `PSTAT2` reader"]
pub struct R(crate::R<PSTAT2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSTAT2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSTAT2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSTAT2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Status Register for Channel Pair 2\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pstat2](index.html) module"]
pub struct PSTAT2_SPEC;
impl crate::RegisterSpec for PSTAT2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pstat2::R](R) reader structure"]
impl crate::Readable for PSTAT2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PSTAT2 to value 0"]
impl crate::Resettable for PSTAT2_SPEC {

#[doc = "Register `PSTAT3` reader"]
pub struct R(crate::R<PSTAT3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSTAT3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSTAT3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSTAT3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Status Register for Channel Pair 3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pstat3](index.html) module"]
pub struct PSTAT3_SPEC;
impl crate::RegisterSpec for PSTAT3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pstat3::R](R) reader structure"]
impl crate::Readable for PSTAT3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PSTAT3 to value 0"]
impl crate::Resettable for PSTAT3_SPEC {

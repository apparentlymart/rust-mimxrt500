#[doc = "Register `DMAC1_CHMUX_SEL7` reader"]
pub struct R(crate::R<DMAC1_CHMUX_SEL7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMAC1_CHMUX_SEL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMAC1_CHMUX_SEL7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMAC1_CHMUX_SEL7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMAC1_CHMUX_SEL7` writer"]
pub struct W(crate::W<DMAC1_CHMUX_SEL7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMAC1_CHMUX_SEL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMAC1_CHMUX_SEL7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMAC1_CHMUX_SEL7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMAC1_CHMUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMAC1_CHMUX_SEL7_SPEC, DMAC1_CHMUX_SEL_A, O>;
...
pub struct DMAC1_CHMUX_SEL7_SPEC;
impl crate::RegisterSpec for DMAC1_CHMUX_SEL7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmac1_chmux_sel7::R](R) reader structure"]
impl crate::Readable for DMAC1_CHMUX_SEL7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmac1_chmux_sel7::W](W) writer structure"]
impl crate::Writable for DMAC1_CHMUX_SEL7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMAC1_CHMUX_SEL7 to value 0"]
impl crate::Resettable for DMAC1_CHMUX_SEL7_SPEC {

...
pub struct R(crate::R<PIO4_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO4_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO4_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO4_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO4_0` writer"]
pub struct W(crate::W<PIO4_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO4_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO4_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO4_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO4_0_SPEC, u8, FSEL_A, 4, O>;
...
pub type PUPDENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, PUPDENA_A, O>;
...
pub type PUPDSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, PUPDSEL_A, O>;
...
pub type IBENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, IBENA_A, O>;
...
pub type SLEWRATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, SLEWRATE_A, O>;
...
pub type FULLDRIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, FULLDRIVE_A, O>;
...
pub type AMENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, AMENA_A, O>;
...
pub type ODENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, ODENA_A, O>;
...
pub type IIENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO4_0_SPEC, IIENA_A, O>;
...
#[doc = "IOPCTL configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio4_0](index.html) module"]
pub struct PIO4_0_SPEC;
impl crate::RegisterSpec for PIO4_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio4_0::R](R) reader structure"]
impl crate::Readable for PIO4_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio4_0::W](W) writer structure"]
impl crate::Writable for PIO4_0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PIO4_0 to value 0"]
impl crate::Resettable for PIO4_0_SPEC {

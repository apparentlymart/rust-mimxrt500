...
#[doc = "Field `MULTITASK` writer - MULTITASK"]
...
#[doc = "`reset()` method sets MODCFG to value 0x0183"]
impl crate::Resettable for MODCFG_SPEC {
    const RESET_VALUE: Self::Ux = 0x0183;
}

...
#[doc = "Field `SEL_PMATCH` reader - Specifies whether the pin interrupts are controlled by the pin interrupt function or by the pattern match function."]
pub type SEL_PMATCH_R = crate::BitReader<SEL_PMATCH_A>;
#[doc = "Specifies whether the pin interrupts are controlled by the pin interrupt function or by the pattern match function.\n\nValue on reset: 0"]
...
#[doc = "Field `SEL_PMATCH` writer - Specifies whether the pin interrupts are controlled by the pin interrupt function or by the pattern match function."]
...
#[doc = "Field `PMAT` reader - Pattern Matches"]
pub type PMAT_R = crate::FieldReader<u8, PMAT_A>;
#[doc = "Pattern Matches\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum PMAT_A {
    #[doc = "1: The corresponding product term is matched by the current state of the appropriate inputs."]
    PMAT_1 = 1,
}
impl From<PMAT_A> for u8 {
    #[inline(always)]
    fn from(variant: PMAT_A) -> Self {
        variant as _
    }
}
impl PMAT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<PMAT_A> {
        match self.bits {
            1 => Some(PMAT_A::PMAT_1),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PMAT_1`"]
    #[inline(always)]
    pub fn is_pmat_1(&self) -> bool {
        *self == PMAT_A::PMAT_1
    }
}
#[doc = "Field `PMAT` writer - Pattern Matches"]
pub type PMAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMCTRL_SPEC, u8, PMAT_A, 8, O>;
impl<'a, const O: u8> PMAT_W<'a, O> {
    #[doc = "The corresponding product term is matched by the current state of the appropriate inputs."]
    #[inline(always)]
    pub fn pmat_1(self) -> &'a mut W {
        self.variant(PMAT_A::PMAT_1)
    }
}
impl R {
    #[doc = "Bit 0 - Specifies whether the pin interrupts are controlled by the pin interrupt function or by the pattern match function."]
    #[inline(always)]
    ...
    #[doc = "Bits 24:31 - Pattern Matches"]
    #[inline(always)]

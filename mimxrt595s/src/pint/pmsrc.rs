...
impl<'a, const O: u8> SRC0_W<'a, O> {
    #[doc = "Input 0. Selects the pin selected in the PINT_SEL0 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input0(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT0)
    }
    #[doc = "Input 1. Selects the pin selected in the PINT_SEL1 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input1(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT1)
    }
    #[doc = "Input 2. Selects the pin selected in the PINT_SEL2 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input2(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT2)
    }
    #[doc = "Input 3. Selects the pin selected in the PINT_SEL3 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input3(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT3)
    }
    #[doc = "Input 4. Selects the pin selected in the PINT_SEL4 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input4(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT4)
    }
    #[doc = "Input 5. Selects the pin selected in the PINT_SEL5 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input5(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT5)
    }
    #[doc = "Input 6. Selects the pin selected in the PINT_SEL6 register as the source to bit slice n."]
    #[inline(always)]
    pub fn input6(self) -> &'a mut W {
        self.variant(SRC0_A::INPUT6)
    }
    #[doc = "Input 7. Selects the pin selected in the PINT_SEL7 register as the source to bit slice n."]
    #[inline(always)]

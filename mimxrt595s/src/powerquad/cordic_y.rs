...
pub type CORDIC_Y_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORDIC_Y` writer - CORDIC input y"]
pub type CORDIC_Y_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CORDIC_Y_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CORDIC input y"]
    #[inline(always)]
    pub fn cordic_y(&self) -> CORDIC_Y_R {
        CORDIC_Y_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - CORDIC input y"]
    #[inline(always)]
    #[must_use]
    pub fn cordic_y(&mut self) -> CORDIC_Y_W<0> {
        CORDIC_Y_W::new(self)
    }

...
#[doc = "Field `GPREG` reader - General Purpose Bank"]
pub type GPREG_R = crate::FieldReader<u32, u32>;
#[doc = "Field `GPREG` writer - General Purpose Bank"]
pub type GPREG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPREG_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - General Purpose Bank"]
    #[inline(always)]
    pub fn gpreg(&self) -> GPREG_R {
        GPREG_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - General Purpose Bank"]
    #[inline(always)]
    #[must_use]
    pub fn gpreg(&mut self) -> GPREG_W<0> {
        GPREG_W::new(self)
    }

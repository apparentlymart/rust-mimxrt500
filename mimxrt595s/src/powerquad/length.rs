...
#[doc = "Field `INST_LENGTH` reader - Instruction length"]
pub type INST_LENGTH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INST_LENGTH` writer - Instruction length"]
pub type INST_LENGTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LENGTH_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Instruction length"]
    #[inline(always)]
    pub fn inst_length(&self) -> INST_LENGTH_R {
        INST_LENGTH_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Instruction length"]
    #[inline(always)]
    #[must_use]
    pub fn inst_length(&mut self) -> INST_LENGTH_W<0> {

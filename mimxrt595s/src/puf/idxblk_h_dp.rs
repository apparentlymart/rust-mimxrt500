...
pub type IDX8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX8_A, 2, O>;
...
pub type IDX9_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX9_A, 2, O>;
...
pub type IDX10_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX10_A, 2, O>;
...
pub type IDX11_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX11_A, 2, O>;
...
pub type IDX12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX12_A, 2, O>;
...
pub type IDX13_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX13_A, 2, O>;
...
pub type IDX14_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX14_A, 2, O>;
...
pub type IDX15_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IDXBLK_H_DP_SPEC, u8, IDX15_A, 2, O>;

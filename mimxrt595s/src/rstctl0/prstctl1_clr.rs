...
pub type SDIO0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRSTCTL1_CLR_SPEC, SDIO0_AW, O>;
...
pub type SDIO1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRSTCTL1_CLR_SPEC, SDIO1_AW, O>;
...
#[doc = "Field `ACMP0` writer - ACMP0 reset clear"]
pub type ACMP0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRSTCTL1_CLR_SPEC, ACMP0_AW, O>;
...
#[doc = "Field `ADC0` writer - ADC0 reset clear"]
pub type ADC0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRSTCTL1_CLR_SPEC, ADC0_AW, O>;
...
#[doc = "Secure HSGPIO0 reset clear\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `SHSGPIO0` writer - Secure HSGPIO0 reset clear"]
pub type SHSGPIO0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRSTCTL1_CLR_SPEC, SHSGPIO0_AW, O>;
...
impl W {
    ...
    #[doc = "Bit 15 - ACMP0 reset clear"]
    #[inline(always)]
    #[must_use]
    pub fn acmp0(&mut self) -> ACMP0_W<15> {
        ACMP0_W::new(self)
    }
    #[doc = "Bit 16 - ADC0 reset clear"]
    #[inline(always)]
    #[must_use]
    pub fn adc0(&mut self) -> ADC0_W<16> {
        ADC0_W::new(self)
    }
    #[doc = "Bit 24 - Secure HSGPIO0 reset clear"]
    #[inline(always)]
    #[must_use]

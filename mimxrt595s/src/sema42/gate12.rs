#[doc = "Register `GATE12` reader"]
pub struct R(crate::R<GATE12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GATE12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GATE12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GATE12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GATE12` writer"]
pub struct W(crate::W<GATE12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GATE12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GATE12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GATE12_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GTFSM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, GATE12_SPEC, u8, GTFSM_A, 4, O>;
...
#[doc = "Gate\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gate12](index.html) module"]
pub struct GATE12_SPEC;
impl crate::RegisterSpec for GATE12_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [gate12::R](R) reader structure"]
impl crate::Readable for GATE12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gate12::W](W) writer structure"]
impl crate::Writable for GATE12_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GATE12 to value 0"]
impl crate::Resettable for GATE12_SPEC {

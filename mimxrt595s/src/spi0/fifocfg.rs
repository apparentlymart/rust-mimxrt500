...
pub enum SIZE_A {
    ...
    SIZE16ENTRIES8BITS = 0,
    #[doc = "1: FIFO is configured as 8 entries of 16 bits."]
    SIZE8ENTRIES16BITS = 1,
    #[doc = "2: Not used"]
    SIZEINVALID2 = 2,
    #[doc = "3: Not used"]
    SIZEINVALID3 = 3,
...
impl SIZE_R {
    ...
    pub fn variant(&self) -> SIZE_A {
        match self.bits {
            0 => SIZE_A::SIZE16ENTRIES8BITS,
            1 => SIZE_A::SIZE8ENTRIES16BITS,
            2 => SIZE_A::SIZEINVALID2,
            3 => SIZE_A::SIZEINVALID3,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `SIZE16ENTRIES8BITS`"]
    #[inline(always)]
    pub fn is_size16entries8bits(&self) -> bool {
        *self == SIZE_A::SIZE16ENTRIES8BITS
    }
    #[doc = "Checks if the value of the field is `SIZE8ENTRIES16BITS`"]
    #[inline(always)]
    pub fn is_size8entries16bits(&self) -> bool {
        *self == SIZE_A::SIZE8ENTRIES16BITS
    }
...
pub enum DMATX_A {
    ...
    DISABLED = 0,
    #[doc = "1: Issues DMA request for the transmit function if the FIFO is not full. Generally, data interrupts would be disabled if DMA is enabled."]
    ENABLED = 1,
}
...
impl<'a, const O: u8> DMATX_W<'a, O> {
    ...
    #[doc = "Issues DMA request for the transmit function if the FIFO is not full. Generally, data interrupts would be disabled if DMA is enabled."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
pub enum DMARX_A {
    ...
    DISABLED = 0,
    #[doc = "1: Issues a DMA request for the receive function if the FIFO is not empty. Generally, data interrupts would be disabled if DMA is enabled."]
    ENABLED = 1,
}
...
impl<'a, const O: u8> DMARX_W<'a, O> {
    ...
    #[doc = "Issues a DMA request for the receive function if the FIFO is not empty. Generally, data interrupts would be disabled if DMA is enabled."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {

...
pub enum TXLVL_A {
    ...
    DISABLED = 0,
    #[doc = "1: If FIFOTRIG\\[TXLVLENA\\]=1, then an interrupt will be generated when the TX FIFO level decreases to the level specified by FIFOTRIG\\[TXLVL\\]"]
    ENABLED = 1,
}
...
impl<'a, const O: u8> TXLVL_W<'a, O> {
    ...
    #[doc = "If FIFOTRIG\\[TXLVLENA\\]=1, then an interrupt will be generated when the TX FIFO level decreases to the level specified by FIFOTRIG\\[TXLVL\\]"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
pub enum RXLVL_A {
    ...
    DISABLED = 0,
    #[doc = "1: If FIFOTRIG\\[RXLVLENA\\]=1, then an interrupt will be generated when the RX FIFO level increases to the level specified by FIFOTRIG\\[RXLVL\\]"]
    ENABLED = 1,
}
...
impl<'a, const O: u8> RXLVL_W<'a, O> {
    ...
    #[doc = "If FIFOTRIG\\[RXLVLENA\\]=1, then an interrupt will be generated when the RX FIFO level increases to the level specified by FIFOTRIG\\[RXLVL\\]"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {

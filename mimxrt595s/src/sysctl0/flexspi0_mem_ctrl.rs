#[doc = "Register `FLEXSPI0_MEM_CTRL` reader"]
pub struct R(crate::R<FLEXSPI0_MEM_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLEXSPI0_MEM_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FLEXSPI0_MEM_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FLEXSPI0_MEM_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FLEXSPI0_MEM_CTRL` writer"]
pub struct W(crate::W<FLEXSPI0_MEM_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FLEXSPI0_MEM_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FLEXSPI0_MEM_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FLEXSPI0_MEM_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MEM_RIG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLEXSPI0_MEM_CTRL_SPEC, MEM_RIG_A, O>;
...
pub type MEM_WIG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLEXSPI0_MEM_CTRL_SPEC, MEM_WIG_A, O>;
...
pub type MEM_STDBY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLEXSPI0_MEM_CTRL_SPEC, MEM_STDBY_A, O>;
...
#[doc = "FlexSPI0 Memory Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flexspi0_mem_ctrl](index.html) module"]
pub struct FLEXSPI0_MEM_CTRL_SPEC;
impl crate::RegisterSpec for FLEXSPI0_MEM_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flexspi0_mem_ctrl::R](R) reader structure"]
impl crate::Readable for FLEXSPI0_MEM_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flexspi0_mem_ctrl::W](W) writer structure"]
impl crate::Writable for FLEXSPI0_MEM_CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FLEXSPI0_MEM_CTRL to value 0"]
impl crate::Resettable for FLEXSPI0_MEM_CTRL_SPEC {

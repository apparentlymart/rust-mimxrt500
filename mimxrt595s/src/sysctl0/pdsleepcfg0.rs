...
pub type MAINCLK_SHUTOFF_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, MAINCLK_SHUTOFF_A, O>;
...
pub type PMIC_MODE0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, PMIC_MODE0_A, O>;
...
pub type PMIC_MODE1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, PMIC_MODE1_A, O>;
...
pub type DEEP_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, DEEP_PD_A, O>;
...
pub type VDDCOREREG_LP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, VDDCOREREG_LP_A, O>;
...
pub type FRO_CG_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, FRO_CG_A, O>;
...
pub type PMCREF_LP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, PMCREF_LP_A, O>;
...
pub type HVD1V8_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, HVD1V8_PD_A, O>;
...
pub type PORCORE_LP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, PORCORE_LP_A, O>;
...
pub type LVDCORE_LP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, LVDCORE_LP_A, O>;
...
pub type HVDCORE_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, HVDCORE_PD_A, O>;
...
pub type RBB_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, RBB_PD_A, O>;
...
pub type FBB_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, FBB_PD_A, O>;
...
pub type SYSXTAL_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, SYSXTAL_PD_A, O>;
...
pub type LPOSC_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, LPOSC_PD_A, O>;
...
#[doc = "Field `RBBSRAM_PD` reader - RBBSRAM"]
...
#[doc = "Field `RBBSRAM_PD` writer - RBBSRAM"]
pub type RBBSRAM_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, RBBSRAM_PD_A, O>;
...
#[doc = "Field `FFRO_PD` reader - FRO 192/96 MHz internal oscillator"]
pub type FFRO_PD_R = crate::BitReader<FFRO_PD_A>;
#[doc = "FRO 192/96 MHz internal oscillator\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FFRO_PD_A {
    #[doc = "0: Enabled"]
    FFRO_PD_0 = 0,
...
#[doc = "Field `FFRO_PD` writer - FRO 192/96 MHz internal oscillator"]
pub type FFRO_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, FFRO_PD_A, O>;
...
pub type SYSPLLLDO_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, SYSPLLLDO_PD_A, O>;
...
pub type SYSPLLANA_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, SYSPLLANA_PD_A, O>;
...
pub type AUDPLLLDO_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, AUDPLLLDO_PD_A, O>;
...
pub type AUDPLLANA_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, AUDPLLANA_PD_A, O>;
...
pub type ADC_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, ADC_PD_A, O>;
...
pub type ADC_LP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, ADC_LP_A, O>;
...
pub type ADC_TEMPSNS_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, ADC_TEMPSNS_PD_A, O>;
...
pub type PMC_TEMPSNS_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, PMC_TEMPSNS_PD_A, O>;
...
pub type ACMP_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDSLEEPCFG0_SPEC, ACMP_PD_A, O>;
...
impl R {
    ...
    #[doc = "Bit 16 - FRO 192/96 MHz internal oscillator"]
    #[inline(always)]
...
#[doc = "`reset()` method sets PDSLEEPCFG0 to value 0x03fe_ac80"]

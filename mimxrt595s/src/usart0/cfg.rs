...
#[doc = "Field `DATALEN` reader - Data Length. Selects the data size for the USART."]
pub type DATALEN_R = crate::FieldReader<u8, DATALEN_A>;
#[doc = "Data Length. Selects the data size for the USART.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum DATALEN_A {
    ...
    BIT_8 = 1,
    #[doc = "2: 9 bit data length. The 9th bit is commonly used for addressing in multidrop mode. See the ADDRDET\\[CTL\\]."]
    BIT_9 = 2,
}
...
#[doc = "Field `DATALEN` writer - Data Length. Selects the data size for the USART."]
...
impl<'a, const O: u8> DATALEN_W<'a, O> {
    ...
    #[doc = "9 bit data length. The 9th bit is commonly used for addressing in multidrop mode. See the ADDRDET\\[CTL\\]."]
    #[inline(always)]
    pub fn bit_9(self) -> &'a mut W {
        self.variant(DATALEN_A::BIT_9)
    }
}
#[doc = "Field `PARITYSEL` reader - Parity Select. Selects what type of parity is used by the USART."]
pub type PARITYSEL_R = crate::FieldReader<u8, PARITYSEL_A>;
#[doc = "Parity Select. Selects what type of parity is used by the USART.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
#[doc = "Field `PARITYSEL` writer - Parity Select. Selects what type of parity is used by the USART."]
...
#[doc = "Field `STOPLEN` reader - Stop Length"]
...
pub enum STOPLEN_A {
    #[doc = "0: 1 stop bit"]
    BIT_1 = 0,
    #[doc = "1: 2 stop bits. This setting should be used only for asynchronous communication."]
    BITS_2 = 1,
}
...
#[doc = "Field `STOPLEN` writer - Stop Length"]
...
impl<'a, const O: u8> STOPLEN_W<'a, O> {
    ...
    #[doc = "2 stop bits. This setting should be used only for asynchronous communication."]
    #[inline(always)]
    pub fn bits_2(self) -> &'a mut W {
        self.variant(STOPLEN_A::BITS_2)
    }
}
#[doc = "Field `MODE32K` reader - Mode 32 kHz"]
...
#[doc = "Field `MODE32K` writer - Mode 32 kHz"]
...
#[doc = "Field `SYNCEN` reader - Synchronous Enable. Selects synchronous or asynchronous operation."]
pub type SYNCEN_R = crate::BitReader<SYNCEN_A>;
#[doc = "Synchronous Enable. Selects synchronous or asynchronous operation.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SYNCEN_A {
...
#[doc = "Field `SYNCEN` writer - Synchronous Enable. Selects synchronous or asynchronous operation."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CLKPOL_A {
    #[doc = "0: Falling edge. RXD is sampled on the falling edge of SCLK."]
    FALLING_EDGE = 0,
    #[doc = "1: Rising edge. RXD is sampled on the rising edge of SCLK."]
    RISING_EDGE = 1,
}
...
impl<'a, const O: u8> CLKPOL_W<'a, O> {
    #[doc = "Falling edge. RXD is sampled on the falling edge of SCLK."]
    #[inline(always)]
    pub fn falling_edge(self) -> &'a mut W {
        self.variant(CLKPOL_A::FALLING_EDGE)
    }
    #[doc = "Rising edge. RXD is sampled on the rising edge of SCLK."]
    #[inline(always)]
...
pub enum OESEL_A {
    ...
    STANDARD = 0,
    #[doc = "1: RS-485. The RTS signal is configured to provide an output enable signal to control an RS-485 transceiver."]
    RS_485 = 1,
}
...
impl<'a, const O: u8> OESEL_W<'a, O> {
    ...
    #[doc = "RS-485. The RTS signal is configured to provide an output enable signal to control an RS-485 transceiver."]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 11 - Synchronous Enable. Selects synchronous or asynchronous operation."]
    #[inline(always)]
    pub fn syncen(&self) -> SYNCEN_R {
        SYNCEN_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Clock Polarity"]
    #[inline(always)]

...
pub enum TXLVLENA_A {
    ...
    DISABLED = 0,
    #[doc = "1: A trigger will be generated if the transmit FIFO level reaches the value specified by the TXLVL field."]
    ENABLED = 1,
}
...
impl<'a, const O: u8> TXLVLENA_W<'a, O> {
    ...
    #[doc = "A trigger will be generated if the transmit FIFO level reaches the value specified by the TXLVL field."]
    #[inline(always)]
...
pub enum RXLVLENA_A {
    ...
    DISABLED = 0,
    #[doc = "1: An trigger will be generated if the receive FIFO level reaches the value specified by the RXLVL field."]
    ENABLED = 1,
}
...
impl<'a, const O: u8> RXLVLENA_W<'a, O> {
    ...
    #[doc = "An trigger will be generated if the receive FIFO level reaches the value specified by the RXLVL field."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {

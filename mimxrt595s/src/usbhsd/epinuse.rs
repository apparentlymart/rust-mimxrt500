...
#[doc = "Field `BUF` reader - Buffer in use."]
pub type BUF_R = crate::FieldReader<u16, BUF_A>;
#[doc = "Buffer in use.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u16)]
pub enum BUF_A {
    #[doc = "0: HW is accessing buffer 0."]
    BUF_0 = 0,
    #[doc = "1: HW is accessing buffer 1."]
    BUF_1 = 1,
}
impl From<BUF_A> for u16 {
    #[inline(always)]
    fn from(variant: BUF_A) -> Self {
        variant as _
    }
}
impl BUF_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<BUF_A> {
        match self.bits {
            0 => Some(BUF_A::BUF_0),
            1 => Some(BUF_A::BUF_1),
            _ => None,
...
#[doc = "Field `BUF` writer - Buffer in use."]
pub type BUF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EPINUSE_SPEC, u16, BUF_A, 10, O>;
impl<'a, const O: u8> BUF_W<'a, O> {
    #[doc = "HW is accessing buffer 0."]
    #[inline(always)]
    pub fn buf_0(self) -> &'a mut W {
        self.variant(BUF_A::BUF_0)
    }
    #[doc = "HW is accessing buffer 1."]
    #[inline(always)]
    pub fn buf_1(self) -> &'a mut W {
        self.variant(BUF_A::BUF_1)
    }
}
impl R {

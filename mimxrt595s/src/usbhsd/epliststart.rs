...
#[doc = "Field `EP_LIST_FIXED` reader - Fixed portion of the USB EP Command/Status List address."]
...
impl R {
    ...
    #[doc = "Bits 20:31 - Fixed portion of the USB EP Command/Status List address."]
    #[inline(always)]
...
#[doc = "`reset()` method sets EPLISTSTART to value 0x4010_0000"]
impl crate::Resettable for EPLISTSTART_SPEC {
    const RESET_VALUE: Self::Ux = 0x4010_0000;
}

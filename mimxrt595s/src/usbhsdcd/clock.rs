...
pub enum CLOCK_UNIT_A {
    #[doc = "0: kHz Speed (between 4 kHz and 1023 kHz)"]
    KHZ_CLK = 0,
...
impl CLOCK_UNIT_R {
    ...
    pub fn variant(&self) -> CLOCK_UNIT_A {
        match self.bits {
            false => CLOCK_UNIT_A::KHZ_CLK,
            true => CLOCK_UNIT_A::MHZ_CLK,
        }
    }
    #[doc = "Checks if the value of the field is `KHZ_CLK`"]
    #[inline(always)]
    pub fn is_khz_clk(&self) -> bool {
        *self == CLOCK_UNIT_A::KHZ_CLK
    }
    #[doc = "Checks if the value of the field is `MHZ_CLK`"]
    #[inline(always)]
    pub fn is_mhz_clk(&self) -> bool {
        *self == CLOCK_UNIT_A::MHZ_CLK
    }
}
...
impl<'a, const O: u8> CLOCK_UNIT_W<'a, O> {
    ...
    #[inline(always)]
    pub fn khz_clk(self) -> &'a mut W {
        self.variant(CLOCK_UNIT_A::KHZ_CLK)
    }
    #[doc = "MHz Speed (between 1 MHz and 1023 MHz)"]
    #[inline(always)]
    pub fn mhz_clk(self) -> &'a mut W {
        self.variant(CLOCK_UNIT_A::MHZ_CLK)
    }
}

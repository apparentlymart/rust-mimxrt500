...
#[doc = "Field `N_PORTS` reader - Number of Physical downstream ports."]
pub type N_PORTS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PPC` reader - Port Power Control"]
pub type PPC_R = crate::BitReader<bool>;
#[doc = "Field `P_INDICATOR` reader - Port Indicator Control"]
pub type P_INDICATOR_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bits 0:3 - Number of Physical downstream ports."]
    #[inline(always)]
    pub fn n_ports(&self) -> N_PORTS_R {
        N_PORTS_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bit 4 - Port Power Control"]
    #[inline(always)]
    pub fn ppc(&self) -> PPC_R {
        PPC_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 16 - Port Indicator Control"]
    #[inline(always)]

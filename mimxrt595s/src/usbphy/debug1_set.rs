...
pub enum ENTAILADJVD_A {
    #[doc = "0: No effect"]
    DISABLE = 0,
    #[doc = "1: Sets the corresponding DEBUG1 bit"]
    ENABLE = 1,
}
...
pub type ENTAILADJVD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_SET_SPEC, u8, ENTAILADJVD_A, 2, O>;
impl<'a, const O: u8> ENTAILADJVD_W<'a, O> {
    ...
    #[doc = "Sets the corresponding DEBUG1 bit"]
    #[inline(always)]
...
pub type USB2_REFBIAS_VBGADJ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_SET_SPEC, u8, USB2_REFBIAS_VBGADJ_A, 3, O>;
...
pub type USB2_REFBIAS_TST_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_SET_SPEC, u8, USB2_REFBIAS_TST_A, 2, O>;
...
#[doc = "`reset()` method sets DEBUG1_SET to value 0"]

...
pub type ENTAILADJVD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_TOG_SPEC, u8, ENTAILADJVD_A, 2, O>;
...
pub enum USB2_REFBIAS_VBGADJ_A {
    #[doc = "0: No effect"]
    DISABLE = 0,
    #[doc = "1: Toggles the corresponding DEBUG1 bit"]
    ENABLE = 1,
}
...
pub type USB2_REFBIAS_VBGADJ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_TOG_SPEC, u8, USB2_REFBIAS_VBGADJ_A, 3, O>;
impl<'a, const O: u8> USB2_REFBIAS_VBGADJ_W<'a, O> {
    ...
    #[doc = "Toggles the corresponding DEBUG1 bit"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
...
pub type USB2_REFBIAS_TST_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_TOG_SPEC, u8, USB2_REFBIAS_TST_A, 2, O>;
...
#[doc = "`reset()` method sets DEBUG1_TOG to value 0"]

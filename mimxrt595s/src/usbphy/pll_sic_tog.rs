...
pub type PLL_EN_USB_CLKS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_SIC_TOG_SPEC, PLL_EN_USB_CLKS_A, O>;
...
pub type PLL_POWER_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_SIC_TOG_SPEC, PLL_POWER_A, O>;
...
pub type PLL_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_SIC_TOG_SPEC, PLL_ENABLE_A, O>;
...
pub type PLL_BYPASS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_SIC_TOG_SPEC, PLL_BYPASS_A, O>;
...
pub type REFBIAS_PWD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_SIC_TOG_SPEC, REFBIAS_PWD_A, O>;
...
pub type PLL_REG_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_SIC_TOG_SPEC, PLL_REG_ENABLE_A, O>;
...
pub type PLL_DIV_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_SIC_TOG_SPEC, u8, PLL_DIV_SEL_A, 3, O>;

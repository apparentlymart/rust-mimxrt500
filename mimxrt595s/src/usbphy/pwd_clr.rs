...
pub enum TXPWDFS_A {
    #[doc = "0: No effect"]
    DISABLE = 0,
    #[doc = "1: Clears the corresponding PWD bit"]
    ENABLE = 1,
}
...
impl TXPWDFS_R {
    ...
    pub fn variant(&self) -> TXPWDFS_A {
        match self.bits {
            false => TXPWDFS_A::DISABLE,
            true => TXPWDFS_A::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == TXPWDFS_A::DISABLE
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == TXPWDFS_A::ENABLE
    }
}
...
impl<'a, const O: u8> TXPWDFS_W<'a, O> {
    ...
    pub fn disable(self) -> &'a mut W {
        self.variant(TXPWDFS_A::DISABLE)
    }
    #[doc = "Clears the corresponding PWD bit"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(TXPWDFS_A::ENABLE)
    }
}

...
pub enum D_CAL_A {
    #[doc = "0: No effect"]
    DISABLE = 0,
    #[doc = "1: Clears the corresponding TX bit"]
    ENABLE = 1,
}
...
impl<'a, const O: u8> D_CAL_W<'a, O> {
    ...
    #[doc = "Clears the corresponding TX bit"]
    #[inline(always)]
...
pub type TXENCAL45DM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_CLR_SPEC, u8, TXENCAL45DM_A, 4, O>;
...
#[doc = "Field `TXENCAL45DN` reader - Clears Enable resistance calibration on DN."]
pub type TXENCAL45DN_R = crate::BitReader<TXENCAL45DN_A>;
#[doc = "Clears Enable resistance calibration on DN.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `TXENCAL45DN` writer - Clears Enable resistance calibration on DN."]
pub type TXENCAL45DN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_CLR_SPEC, TXENCAL45DN_A, O>;
...
pub type TXCAL45DP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_CLR_SPEC, u8, TXCAL45DP_A, 4, O>;
...
pub type TXENCAL45DP_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_CLR_SPEC, TXENCAL45DP_A, O>;
...
impl R {
    ...
    #[doc = "Bit 13 - Clears Enable resistance calibration on DN."]
    #[inline(always)]
...
#[doc = "`reset()` method sets TX_CLR to value 0x0007_0707"]

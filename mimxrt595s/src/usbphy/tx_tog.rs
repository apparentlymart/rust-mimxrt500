...
pub enum D_CAL_A {
    #[doc = "0: No effect"]
    DISABLE = 0,
    #[doc = "1: Toggles the corresponding TX bit"]
    ENABLE = 1,
}
...
impl<'a, const O: u8> D_CAL_W<'a, O> {
    ...
    #[doc = "Toggles the corresponding TX bit"]
    #[inline(always)]
...
pub type TXENCAL45DM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, TXENCAL45DM_A, 4, O>;
...
pub type TXENCAL45DN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_TOG_SPEC, TXENCAL45DN_A, O>;
...
pub type TXCAL45DP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, TXCAL45DP_A, 4, O>;
...
pub type TXENCAL45DP_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_TOG_SPEC, TXENCAL45DP_A, O>;
...
#[doc = "`reset()` method sets TX_TOG to value 0x0007_0707"]

...
pub type PULLUP_DP_R = crate::BitReader<bool>;
#[doc = "Field `PULLUP_DP` writer - PULLUP_DP"]
pub type PULLUP_DP_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB1_CHRG_DETECT_SPEC, bool, O>;
#[doc = "Field `BGR_IBIAS` reader - USB charge detector bias current reference"]
pub type BGR_IBIAS_R = crate::BitReader<BGR_IBIAS_A>;
#[doc = "USB charge detector bias current reference\n\nValue on reset: 0"]
...
#[doc = "Field `BGR_IBIAS` writer - USB charge detector bias current reference"]
pub type BGR_IBIAS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_CHRG_DETECT_SPEC, BGR_IBIAS_A, O>;
...
impl R {
    ...
    #[doc = "Bit 23 - USB charge detector bias current reference"]
    #[inline(always)]

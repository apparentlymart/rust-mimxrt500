...
pub struct R(crate::R<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USB1_LOOPBACK_HSFSCNT_CLR` writer"]
pub struct W(crate::W<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB1_LOOPBACK_HSFSCNT_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TSTI_HS_NUMBER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_LOOPBACK_HSFSCNT_CLR_SPEC, u16, TSTI_HS_NUMBER_A, 16, O>;
...
pub type TSTI_FS_NUMBER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_LOOPBACK_HSFSCNT_CLR_SPEC, u16, TSTI_FS_NUMBER_A, 16, O>;
...
#[doc = "USB PHY Loopback Packet Number Select Clear\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usb1_loopback_hsfscnt_clr](index.html) module"]
pub struct USB1_LOOPBACK_HSFSCNT_CLR_SPEC;
impl crate::RegisterSpec for USB1_LOOPBACK_HSFSCNT_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usb1_loopback_hsfscnt_clr::R](R) reader structure"]
impl crate::Readable for USB1_LOOPBACK_HSFSCNT_CLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usb1_loopback_hsfscnt_clr::W](W) writer structure"]
impl crate::Writable for USB1_LOOPBACK_HSFSCNT_CLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USB1_LOOPBACK_HSFSCNT_CLR to value 0x0004_0010"]
impl crate::Resettable for USB1_LOOPBACK_HSFSCNT_CLR_SPEC {

...
pub type UTMI_TESTSTART_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, UTMI_TESTSTART_A, O>;
...
pub type UTMI_DIG_TST0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, UTMI_DIG_TST0_A, O>;
...
pub type UTMI_DIG_TST1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, UTMI_DIG_TST1_A, O>;
...
pub type TSTI_TX_LS_MODE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, TSTI_TX_LS_MODE_A, O>;
...
pub type TSTI_TX_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, TSTI_TX_EN_A, O>;
...
pub type TSTI_TX_HIZ_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, TSTI_TX_HIZ_A, O>;
...
pub type TSTI_HSFS_MODE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, TSTI_HSFS_MODE_EN_A, O>;
...
pub type TSTPKT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, USB1_LOOPBACK_SET_SPEC, u8, TSTPKT_A, 8, O>;

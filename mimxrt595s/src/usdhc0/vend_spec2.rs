...
pub type HS400_WR_CLK_STOP_EN_R = crate::BitReader<bool>;
#[doc = "Field `HS400_WR_CLK_STOP_EN` writer - HS400 write clock stop enable"]
pub type HS400_WR_CLK_STOP_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, VEND_SPEC2_SPEC, bool, O>;
#[doc = "Field `HS400_RD_CLK_STOP_EN` reader - HS400 read clock stop enable"]
pub type HS400_RD_CLK_STOP_EN_R = crate::BitReader<bool>;
#[doc = "Field `HS400_RD_CLK_STOP_EN` writer - HS400 read clock stop enable"]
pub type HS400_RD_CLK_STOP_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, VEND_SPEC2_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn hs400_wr_clk_stop_en(&self) -> HS400_WR_CLK_STOP_EN_R {
        HS400_WR_CLK_STOP_EN_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - HS400 read clock stop enable"]
    #[inline(always)]
    pub fn hs400_rd_clk_stop_en(&self) -> HS400_RD_CLK_STOP_EN_R {
        HS400_RD_CLK_STOP_EN_R::new(((self.bits >> 11) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hs400_wr_clk_stop_en(&mut self) -> HS400_WR_CLK_STOP_EN_W<10> {
        HS400_WR_CLK_STOP_EN_W::new(self)
    }
    #[doc = "Bit 11 - HS400 read clock stop enable"]
    #[inline(always)]
    #[must_use]
    pub fn hs400_rd_clk_stop_en(&mut self) -> HS400_RD_CLK_STOP_EN_W<11> {
        HS400_RD_CLK_STOP_EN_W::new(self)
    }
    #[doc = "Bit 12 - Argument2 register enable for ACMD23"]
    #[inline(always)]
    #[must_use]
